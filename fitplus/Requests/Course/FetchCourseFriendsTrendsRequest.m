//
//  FetchCourseFriendsTrendsRequest.m
//  fitplus
//
...
@implementation FetchCourseFriendsTrendsRequest
- (void)request:(ParamsBlock)paramsBlock result:(RequestResultHandler)resultHandler {
    ...
    [[RequestManager sharedNewInstance] POST:@"fit-port-normal/course/selectCourseNewsList" parameters:[self buildParam:param] success:^(NSURLSessionDataTask *task, id responseObject) {
